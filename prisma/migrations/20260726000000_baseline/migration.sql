-- Baseline migration. Object order intentionally supports a clean database.
CREATE TABLE "User" (
  "id" TEXT NOT NULL,
...
CREATE TABLE "ImportHistory" (
  "id" TEXT NOT NULL, "portfolioId" TEXT NOT NULL, "broker" TEXT NOT NULL,
  "fileName" TEXT NOT NULL, "fileFingerprint" TEXT NOT NULL, "holdingCount" INTEGER NOT NULL,
  "portfolioValue" DECIMAL(18,4) NOT NULL, "status" "ImportStatus" NOT NULL DEFAULT 'COMPLETED',
  "isActive" BOOLEAN NOT NULL DEFAULT false, "importedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT "ImportHistory_pkey" PRIMARY KEY ("id")
);

CREATE TABLE "Holding" (
  "id" TEXT NOT NULL, "portfolioId" TEXT NOT NULL, "importId" TEXT NOT NULL,
  "symbol" TEXT NOT NULL, "companyName" TEXT, "sector" TEXT, "shares" DECIMAL(18,6) NOT NULL,
  "costBasis" DECIMAL(18,4), "currentPrice" DECIMAL(18,4), "marketValue" DECIMAL(18,4) NOT NULL,
  "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "Holding_pkey" PRIMARY KEY ("id")
);

CREATE TABLE "CSVImportLog" (
  "id" TEXT NOT NULL, "importHistoryId" TEXT NOT NULL, "rawCsv" TEXT NOT NULL,
  "detectedHeaders" JSONB NOT NULL, "warnings" JSONB, "errorCount" INTEGER NOT NULL DEFAULT 0,
  "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "CSVImportLog_pkey" PRIMARY KEY ("id")
);
